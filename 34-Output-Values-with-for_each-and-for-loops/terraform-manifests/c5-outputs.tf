...
output "virtual_network_name_list_one_output" {
...
# Output - For Loop Two Inputs, List Output Vwhich is Iterator i (var.environment)
output "virtual_network_name_list_two_output" {
  description = "Virtual Network - For Loop Two Inputs, List Output Vwhich is Iterator i (var.environment)"
...
output "virtual_network_name_map_one_input" {
  description = "Virtual Network - Output - For Loop One Input and Map Output with VNET ID and VNET Name"
...
output "virtual_network_name_keys_funcation" {
  description = "Virtual Network - Output - Terraform keys() function: keys takes a map and returns a list containing the keys from that map"
...
output "virtual_network_name_values_funcation" {
  description = "Virtual Network - Output - Terraform keys() function: keys takes a map and returns a list containing the keys from that map"
