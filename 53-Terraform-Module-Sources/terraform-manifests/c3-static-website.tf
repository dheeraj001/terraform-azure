...
module "azure_static_website" {
  ...
  #source = "github.com/dheeraj001/terraform-azurerm-staticwebsitepublic"
  ...
  #source = "git@github.com:dheeraj001/terraform-azurerm-staticwebsitepublic.git"

  # Generic GIT repo: Github HTTPS with selecting a Specific Release Tag
  source = "git::https://github.com/dheeraj001/terraform-azurerm-staticwebsitepublic.git?ref=1.0.0"
